...
/*
 1) NOTE THIS IS VERY CPU INTENSIVE IF YOU ARE EXPERIENCING TIMEOUTS ENSURE YOUR CPU IS NOT THROTTLING!!!
 2) ALSO NOTE YOU MUST RUN JEST SINGLE THREADED WITH --runInBand

  AGAIN DO NOT RUN JEST MULTI THREADED!!!!
*/
